...
-- INSERT INTO volunteers (id, name, email, phone, department, password, isActive, completedTasks)
-- VALUES 
--   ('volunteer1', 'Alice Wilson', 'alice@example.com', '+91 98765 43210', 'Public Works', 'password123', true, 15),
--   ('volunteer2', 'Bob Brown', 'bob@example.com', '+91 98765 43211', 'Emergency Services', 'password123', true, 23)
